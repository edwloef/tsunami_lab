...
tsunami_lab::patches::DynamicWavePropagation1d<
    Solver>::DynamicWavePropagation1d(t_idx i_nCells, Solver i_solver) {
    m_solver = i_solver;
    m_nCells = i_nCells;
...
template <typename Solver>
tsunami_lab::patches::DynamicWavePropagation1d<
    Solver>::DynamicWavePropagation1d::~DynamicWavePropagation1d() {
    delete[] m_h;
    delete[] m_hu;
    delete[] m_b;
...
template <typename Solver>
tsunami_lab::t_real
tsunami_lab::patches::DynamicWavePropagation1d<Solver>::timeStep(t_real i_dxy) {
...
template <typename Solver>
void tsunami_lab::patches::DynamicWavePropagation1d<
...
template <typename Solver>
void tsunami_lab::patches::DynamicWavePropagation1d<Solver>::setGhostOutflow() {
    // set left boundary
    m_h[0] = m_h[1];
    m_hu[0] = m_hu[1];
...
template class tsunami_lab::patches::DynamicWavePropagation1d<
