 ...
 **/
#ifndef TSUNAMI_LAB_PATCHES_DYNAMIC_WAVE_PROPAGATION_1D
#define TSUNAMI_LAB_PATCHES_DYNAMIC_WAVE_PROPAGATION_1D

#include "WavePropagation.h"

namespace tsunami_lab {
namespace patches {
template <typename Solver> class DynamicWavePropagation1d;
}
} // namespace tsunami_lab

template <typename Solver>
class tsunami_lab::patches::DynamicWavePropagation1d : public WavePropagation {
  private:
    Solver m_solver;
  ...
  public:
     ...
     **/
    DynamicWavePropagation1d(t_idx i_nCells, Solver i_solver);

    /**
     * Destructor which frees all allocated memory.
     **/
    ~DynamicWavePropagation1d();
