...
TEST_CASE("Test the derivation of the FWave net-updates.", "[FWaveUpdates]") {
     ...
     */
    solver.netUpdates(10, 9, -30, 27, 0, 0, netUpdateL, netUpdateR, lambda);
    ...
    */
    solver.netUpdates(4, 3, 40, 30, 0, 0, netUpdateL, netUpdateR, lambda);
    ...
    */
     ...
     *                      | s2 |   | -88.25985     |
     */
    solver.netUpdates(10, 8, 0, 0, 0, 0, netUpdateL, netUpdateR, lambda);
     ...
     *  hu:   0 |  0
     */
    solver.netUpdates(10, 10, 0, 0, 0, 0, netUpdateL, netUpdateR, lambda);
