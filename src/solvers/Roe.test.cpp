...
TEST_CASE("Test the derivation of the Roe wave speeds.", "[RoeStrengths]") {
     ...
     * Inversion yields:
     *
     * wolframalpha.com query: invert {{1, 1},
     * {-9.7311093998375095, 9.5731051658991654}}
     *
     ...
     *
     * wolframalpha.com query: {{0.49590751974393229, -0.051802159398648326},
     * {0.50409248025606771, 0.051802159398648326}} * {9-10, 27--30}
     *
...
TEST_CASE("Test the derivation of the Roe net-updates.", "[RoeUpdates]") {
     ...
     *  hu:  -30 | 27
     *
     * The derivation of the Roe speeds (s1, s2) and wave strengths (a1, a1) is
     * given above.
     *
    ...
    tsunami_lab::solvers::Roe::netUpdates(10, 9, -30, 27, l_netUpdatesL,
                                          l_netUpdatesR);
     ...
     *                      | s2 |   | -88.25985     |
     */
    tsunami_lab::solvers::Roe::netUpdates(10, 8, 0, 0, l_netUpdatesL,
                                          l_netUpdatesR);
     ...
     *  hu:   0 |  0
     */
    tsunami_lab::solvers::Roe::netUpdates(10, 10, 0, 0, l_netUpdatesL,
                                          l_netUpdatesR);
